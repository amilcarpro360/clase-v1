...
// Puerto 5000 para evitar el error EADDRINUSE
...
mongoose.connect(MONGO_URI).then(() => console.log("¡Base de datos conectada!"));
        ...
        <body>
            ...
            <div class="container">
                <div id="sec-apuntes" class="section active">
                    ...
                    ${todos.filter(i=>i.tipo==='apunte').reverse().map(i=>`<div class="card"><b>${i.titulo}</b><br><small>${i.autor}</small></div>`).join('')}
                </div>
                ...
                <div id="sec-dudas" class="section">
                    <form action="/publicar" method="POST" enctype="multipart/form-data" class="card">
                        ...
                        <button style="background:#00b894; color:white; border:none;">Preguntar</button>
                    </form>
                ...
                <div id="sec-admin" class="section">
                    <h3>Alumnos (${todosUsuarios.length})</h3>
                    ${todosUsuarios.map(u => `
                        <div class="card" style="display:flex; align-items:center; gap:10px; padding:10px;">
                            ...
                            <form action="/borrar-cuenta/${u._id}" method="POST" style="margin:0; width:40px;">
                                <button style="background:red; color:white; border:none;">🗑️</button>
                            </form>
                        </div>
                    `).join('')}
                </div>
